...
* [String](#string)     
    ...
    * [Uso](#uso)  
    * [Métodos](#metodos)   
        * [set - Define uma string](#set)
        * [get - Retorna a string alterada](#get)
        * [word_exists - Verifica se palavra existe na frase](#word_exists)
        * [start_with - Verifica se frase começa com uma string](#start_with)
        * [end_with - Verifica se frase termina com uma string](#end_with)
        * [is_html - Checa se contém chaves HTML](#is_html)
        * [is_xml - Checa se contém chaves XML](#is_xml)
        * [is_json - Checa se é Json](#is_json)
        * [is_serialized - Checa se foi Serializado](#is_serialized)
        * [string_only - Filtra caracteres especiais e números](#string_only) 
        * [numeric_only - Filtra números](#numeric_only)
        * [alpha_num - Filtra alfanuméricos](#alpha_num)
        * [accent_remove - Removendo acentos](#accent_remove)
        * [trim - Retira espaço no início e final](#trim)
        * [ltrim - Retira espaço no início](#ltrim)
        * [rtrim - Retira espaço no final](#rtrim)
        * [upper - Converte string para maiúscula](#upper)
        * [lower - Converte string para minúsculas](#lower)
        * [first_upper - Converte o primeiro caracter para maiúscula](#first_upper)
        * [first_lower - Converte o primeiro caracter para minúscula](#first_lower) 
        * [capitalize - Converte primeiro caracter de cada palavra em maiúsculas](#capitalize) 
        * [replace - Substitui em um string](#replace)
        * [clear_end - Remove o último carácter](#clear_end)
        * [truncate_words - Truncar texto sem cortar as palavras](#truncate_words)
        * [truncate_chars - Truncar texto pela quantidade de carácteres](#truncate_chars)
        * [mask - Máscara de strings](#mask)
        * [mask_trunc - Trunca um string mascarado](#mask_trunc) 
        * [unmask - Retira máscaras de um string](#unmask)
        * [mask_string - Transforma número em mascara de caracteres](#mask_string)
        * [code_remove - Remover código](#code_remove)
        * [entities_add - Converte em entidades Html](#entities_add)
        * [entities_remove - Converte em caracteres Html](#entities_remove)
...
`Simpla\String\Str` é uma classe que contém muitas funções úteis para trabalhar com strings codoficadas em utf-8.    
